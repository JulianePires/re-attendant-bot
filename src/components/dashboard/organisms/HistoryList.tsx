...
import { obterAtendimentosDoDia } from "@/server/actions/atendimento";
...
export function HistoryList() {
  ...
  const renderizaComponentePorStatus = () => {
    ...
    if (isLoading) {
      return <CarregandoPlaceholder mensagem="Carregando atendimentos do dia..." />;
    }
    if (atendimentos.length === 0) {
      return <VazioPlaceholder mensagem="Nenhum atendimento encontrado para hoje." />;
    }
    return (
